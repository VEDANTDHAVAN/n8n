...
import { fetchHttpRequestTokenRealtime } from "./actions";
...
export const HttpRequestNode = memo((props: NodeProps<HttpRequestNodeType>) => {
  ...
  const nodeStatus = useNodeStatus({
    ...
    topic: "status",
    refreshToken: fetchHttpRequestTokenRealtime,
  });
  ...
  const handleSubmit = (values: HttpRequestFormValues) => {
    ...
    return (
      <>
       <HTTPRequestDialog onSubmit={handleSubmit} defaultValues={nodeData}
