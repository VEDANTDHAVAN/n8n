...
const formSchema = z.object({
  ...
  body: z.string().optional()//.refine() JSON5
});
    ...
    <DialogContent>
     ...
     <Form {...form}>
      ...
      >
       ...
       />  
       <FormField control={form.control} name="method"
        render={({field}) => (
          <FormItem>
       ...
       /> 
       <FormField control={form.control} name="endpoint"
        render={({field}) => (
          <FormItem>
           <FormLabel>Endpoint URL</FormLabel> 
           <FormControl>
            <Input placeholder="http://api.example.com/users/123" {...field} />
           </FormControl>
           <FormDescription>
