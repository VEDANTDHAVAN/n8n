...
export const ExecutionsHeader = () => {
    return (
        <EntityHeader title="Executions" description="View your workflow execution history" 
        />
    );
};
...
export const ExecutionsPagination = () => {
    ...
    return (
        <EntityPagination disabled={executions.isFetching} onPageChange={
            (page) => setParams({ ...params, page })
        } 
         totalPages={executions.data.totalPages} page={executions.data.page}  />
    )
}
...
export const ExecutionsEmpty = () => {
 return (
    <EmptyView
     message="You haven't created performed any executions yet!! Get started by running your first workflow" />
 )
};
...
export const ExecutionItem = ({
 ...
 return (
    <EntityItem href={`/executions/${data.id}`} title={formatStatus(data.status)}
     subtitle={subtitle}
